        ...
        switch kk
            case 1
                if any(pulse_on)
                    ...
                    %detect pulse events
                    [onset,offset,pulse,center] = getPulseTime(fname,i,'pulse','events',[pulse_on pulse_off],'thres',thres1);
                    label = 'pulse';
                end
            ...
            case 2
                if any(sine_on)
                    label = 'sine';
                    %detect sine events
                    [onset,offset,pulse,center] = getPulseTime(fname,i,'sine','events',[sine_on sine_off],'thres',thres1,'thres1',thres2);
                end
        end
...
outfile = [fname(1:end-13) '.evt.ait'];
...
outfile = [fname(1:end-13) '.evt.aip'];
